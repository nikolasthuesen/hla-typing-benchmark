...
IN_1="/home/projects/ht3_bmem/people/nikthu/cut_dmg/shortened_reads/${read_length}_read_length/${coverage}X_coverage/${sample_id}.bam_reads1.fastq.gz"
IN_2="/home/projects/ht3_bmem/people/nikthu/cut_dmg/shortened_reads/${read_length}_read_length/${coverage}X_coverage/${sample_id}.bam_reads2.fastq.gz"
OUTPUT_FOLDER="/home/projects/ht3_bmem/people/nikthu/cut_dmg/output/${read_length}_read_length/${coverage}X_coverage/"
...
#python /services/tools/optitype/1.3.4/OptiTypePipeline.py -i $IN_1 $IN_2 -d -v -o $OUTPUT_FOLDER --prefix $sample_id
