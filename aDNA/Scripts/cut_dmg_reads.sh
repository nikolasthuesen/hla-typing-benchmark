...
/home/projects/ht3_bmem/people/nikthu/gargammel/src/fragSim --fq -l ${READ_LENGTH} ${IN_FASTQ1} | sed -n '1~4s/^@/>/p;2~4p' | /home/projects/ht3_bmem/people/nikthu/gargammel/src/deamSim -matfile /home/projects/ht3_bmem/people/nikthu/deamSim_matfiles/KH150289. /dev/stdin > $tempdir/tmp_reads1.fa 
/home/projects/ht3_bmem/people/nikthu/gargammel/src/fragSim --fq -l ${READ_LENGTH} ${IN_FASTQ2} | sed -n '1~4s/^@/>/p;2~4p' | /home/projects/ht3_bmem/people/nikthu/gargammel/src/deamSim -matfile /home/projects/ht3_bmem/people/nikthu/deamSim_matfiles/KH150289. /dev/stdin > $tempdir/tmp_reads2.fa 

#Map read pairs to bam file for later downsampling
bwa mem /home/projects/cu_10148/people/nikthu/data/ref_genome_data/GRCh38_full_analysis_set_plus_decoy_hla.fa -t ${N_CORE} $tempdir/tmp_reads1.fa $tempdir/tmp_reads2.fa | samtools view -b -o - | samtools sort --threads $N_CORE -o "${OUT_BAM}"
