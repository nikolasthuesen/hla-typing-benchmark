...
while read sample_id; do
    ...
    IN=/home/projects/cu_10148/people/nikthu/data/1000G_ten_benchmark/${sample_id}.bam
    OUT=/home/projects/ht3_bmem/people/nikthu/data/${sample_id}

    samtools collate --threads $N_CORE "${IN}" -O | samtools fastq -@ $N_CORE -0 "${OUT}_reads_null.fastq.gz" -1 "${OUT}_reads1.fastq.gz" -2 "${OUT}_reads2.fastq.gz" -s "${OUT}_reads_singletons.fastq.gz" -
